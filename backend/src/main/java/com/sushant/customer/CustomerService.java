...
import com.sushant.exception.DuplicateResourceException;
import com.sushant.exception.RequestValidationException;
import com.sushant.exception.ResourceNotFoundException;
...
public class CustomerService {
    ...
    public byte[] getCustomerProfileImage(Integer customerId) {
        ...
        if (customer.profileImageId() == null || customer.profileImageId().trim().isEmpty()) {
            throw new ResourceNotFoundException(
